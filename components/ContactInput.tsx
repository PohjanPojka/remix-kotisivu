            ...
            <fetcher.Form method="post" action="/contact">
                ...
                <div className="sm:flex text-xl sm:text-medium items-center">
                    <div className="justify-items-start">
                        ...
                        <textarea required type="text" name="content" className="w-full sm:w-96 h-32 outline bg-gray-800 outline-1 outline-gray-600 text-gray-300 rounded-lg p-3 font-normal"></textarea>
                    </div>
