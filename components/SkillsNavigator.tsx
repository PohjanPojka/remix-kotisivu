...
export default function App() {
    ...
    return (
        <>
            <ul className="flex justify-center flex-wrap gap-4 p-4 pt-8 text-white font-montserrat font-medium w-full">
                ...
                <div className="w-2/3">
                    <Card className="bg-gray-800 text-white font-montserrat">
                        <CardHeader className="flex justify-between font-semibold">
                            <Link  href={state[2]}>{state[0]}</Link>
                    ...
                    <Divider className="bg-gray-400"/>
                        ...
                        <CardFooter>
                            <div className="flex text-green-400"><HiOutlineChevronRight/><HiOutlineChevronRight/><HiOutlineChevronRight/><HiOutlineChevronRight/></div>
                        </CardFooter>
                    </Card>
                </div>
            </div>
