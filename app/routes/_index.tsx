...
export const loader = async (args: LoaderFunctionArgs) => {
    ...
    const fileContent = await fs.readFile(jsonDirectory + "/blogData.json", "utf-8");
        ...
        <>
            ...
            <div className="py-8 text-white font-montserrat" id="portfolio">
                ...
                <div className="gap-2 space-y-4 px-4 sm:px-24">
                    ...
                    <ProjectCard name="archpkg-plasmoid" desc="KDE Plasma- työpöytäympäristön widgetti, joka näyttää uusimmat päivitykset Arch Linuxin sovelluspakkauksiin." langs={[ "devicon-qt-original colored", "devicon-javascript-plain", "" ]} git="https://github.com/PohjanPojka/archpkg-plasmoid" links=""/>
                </div>
            </div>
            <Divider className="bg-gray-500"/>
            <div className="flex w-full justify-center font-montserrat">
                <p className="pt-8 font-semibold underline text-white text-5xl">Osaamiseni</p>
            </div>
            <SkillsNavigator/>
            <Divider className="bg-gray-500"/>
            <div className="p-8 text-white font-montserrat">
                <p className="font-semibold text-5xl underline pb-6">Blogi</p>
